            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="test">
                <c:forEach items="${menus}" var="m" varStatus="s">
                    <li
                        ...
                        <a href="javascript:;">
                            <!-- <i class="layui-icon" style="font-size:16px;">&#xe623;</i> -->${m.resName}</a>
                        <dl class="layui-nav-child">
                            <c:forEach items="${m.children}" var="cm">
                                <dd>
                                    <a href="${cm.resUrl}${cm.id}" onclick="setIframeSrc('${cm.resUrl}${cm.id}')" target="myiframe"
                                        nav-n="${m.resName},${cm.resName},${cm.resUrl},${cm.icon}"><i
                                        class="layui-icon">&#xe617;</i>${cm.resName}</a>
                                </dd>
                            </c:forEach>
                        </dl>
                    </li>
