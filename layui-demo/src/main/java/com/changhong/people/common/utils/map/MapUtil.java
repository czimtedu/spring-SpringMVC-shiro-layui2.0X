 ...
 * @Title: MapUtil.java   
 * @Package com.ybdc.yy.user.test.geocodetest   
 * @Description: TODO   
 * @Author: chenhoudong     
 * @Date: 2017年5月17日 下午2:44:01   
 * @Version V1.0 
 * @CopyRight: 2017 www.changhong.com Inc. All rights reserved. 
 */

package com.changhong.people.common.utils.map;
 ...
 * @Description：高德地图工具类
 * @Author：chenhoudong
 * @Date：2017年5月17日下午5:49:40 
 * @version：1.0.0
 */

public class MapUtil {
	// 高德秘钥
	// public static String key = "1da8ea5d3653cdef862b805333f3465a";
	public String key;
	// url前缀
	private String baseUrl = "http://restapi.amap.com/v3/";

	public MapUtil(String key) {
		this.key = key;
	}
	 ...
	 * @Description：
	 * @Creator：chenhoudong
	 * @CreateTime：2017年5月19日上午9:53:46 
	 * @Modifier： 
	 * @ModifyTime：
	 */

	public  BigDecimal getDistanceByGaoDe(BigDecimal originlon, BigDecimal originlat, BigDecimal deslon,
			BigDecimal deslat) {
	 ...
	 * @Description：
	 * @Creator：chenhoudong
	 * @CreateTime：2017年5月17日下午6:03:12 
	 * @Modifier： 
	 * @ModifyTime：
	 */

	public  BigDecimal getDistanceByGeometry(double startlongitude, double startdimensionality,
	 ...
	 * @Description：
	 * @Creator：chenhoudong
	 * @CreateTime：2017年5月17日下午5:28:56 
	 * @Modifier：
	 *  @ModifyTime：
	 */
	 ...
	 * @return
	 * @ReturnType：String 格式为 "经度，纬度" 
	 * @Description：
	 * @Creator：chenhoudong
	 * @CreateTime：2017年5月17日下午5:27:32 
	 * @Modifier： 
	 * @ModifyTime：
	 */

	public  String convert(BigDecimal lon, BigDecimal lat) {
	 ...
	 * @Description：
	 * @Creator：chenhoudong
	 * @CreateTime：2017年5月17日下午4:12:46 
	 * @Modifier： 
	 * @ModifyTime：
	 */
	public  String getAddress(BigDecimal lon, BigDecimal lat) {
	 ...
	 * @Description：
	 * @Creator：chenhoudong
	 * @CreateTime：2017年5月17日下午3:45:39 
	 * @Modifier：
	 * @ModifyTime：
	 */
	 ...
	 * @Description：
	 * @Creator：chenhoudong
	 * @CreateTime：2017年5月22日下午2:53:47 
	 * @Modifier： 
	 * @ModifyTime：
	 */

	public  String getLocalCity(BigDecimal lon, BigDecimal lat) {
		String location = lon + "," + lat;
...
//		String key = "1da8ea5d3653cdef862b805333f3465a";
//		MapUtil mapUtil = new MapUtil(key);
//		// 格式： 经度,纬度
//		// 注意：高德最多取小数点后六位
...
//
//		String coordinate = mapUtil.coordinate(address); // 高德坐标
//		BigDecimal distance = mapUtil.getDistanceByGaoDe(originlon, originlat, deslon, deslat); // 高德距离
//		BigDecimal distance1 = mapUtil.getDistanceByGeometry(104.043390, 30.641982, 106.655347, 31.786691);// 几何距离
...
//		String moordsys = mapUtil.convert(coordsyslon, coordsyslat); // 高德坐标
//		System.out.println(moordsys);
//		System.out.println("=================================================");
//		BigDecimal lon = new BigDecimal(104.06342);
//		BigDecimal lat = new BigDecimal(30.541304);
//		String address2 = mapUtil.getAddress(lon, lat);
//		System.out.println(address2);
//		System.out.println(mapUtil.getLocalCity(originlon, originlat));
//	}
}