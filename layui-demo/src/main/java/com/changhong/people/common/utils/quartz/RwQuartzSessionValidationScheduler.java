 ...
 */
@Component
public class RwQuartzSessionValidationScheduler implements SessionValidationScheduler {

    public static final long DEFAULT_SESSION_VALIDATION_INTERVAL = DefaultSessionManager.DEFAULT_SESSION_VALIDATION_INTERVAL;
    private static final String JOB_NAME = "SessionValidationJob";
    private static final Logger log = LoggerFactory.getLogger(RwQuartzSessionValidationScheduler.class);
    private static final String SESSION_MANAGER_KEY = RwQuartzSessionValidationJob.SESSION_MANAGER_KEY;
    ...
    public RwQuartzSessionValidationScheduler() {
    }

    public RwQuartzSessionValidationScheduler(ValidatingSessionManager sessionManager) {
	...
	public void enableSessionValidation() {
        ...
        try {
            ...
            JobDetail detail = JobBuilder.newJob(RwQuartzSessionValidationJob.class)
